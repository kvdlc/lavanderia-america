...
export default function NuevaPromocionPage() {
  ...
  return (
    <div className="space-y-6 max-w-xl">
      ...
      <h2 className="text-2xl font-bold text-brand-blue">Nueva Promocion</h2>
      <Card>
        <CardHeader>
        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <Input id="title" value={form.title} onChange={(e) => setForm({ ...form, title: e.target.value })} placeholder="Ej: 20% de descuento" required />
            </div>
            <div>
              <Label htmlFor="desc">Descripcion</Label>
              <Textarea id="desc" value={form.description} onChange={(e) => setForm({ ...form, description: e.target.value })} placeholder="Detalles de la promocion" rows={3} />
            </div>
            <div>
              <Label htmlFor="discount">Descuento (%)</Label>
              <Input id="discount" type="number" min="0" max="100" value={form.discount_percent} onChange={(e) => setForm({ ...form, discount_percent: e.target.value })} placeholder="0" />
            </div>
